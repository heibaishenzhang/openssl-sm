...
#define ByteSub(_AA) (Sbox[(_AA) >> 24 & 0xFF] << 24 ^ Sbox[(_AA) >> 16 & 0xFF] << 16 ^ \
        Sbox[(_AA) >>  8 & 0xFF] <<  8 ^ Sbox[(_AA) & 0xFF])
#define L1(_B) ((_B) ^ Rotl(_B, 2) ^ Rotl(_B, 10) ^ Rotl(_B, 18) ^ Rotl(_B, 24))
#define L2(_B) ((_B) ^ Rotl(_B, 13) ^ Rotl(_B, 23))


void SMS4_crypt(muint8 *Input, muint8 *Output, muint32 *rk)
{
...
void SMS4_init_key(muint8 *Key, muint32 *rk, muint32 CryptFlag)
{
     muint32 r, mid, x0, x1, x2, x3, *p;
     p = (muint32 *)Key;
     x0 = p[0];
